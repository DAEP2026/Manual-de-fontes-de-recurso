...
const FONTES = [
  ...
  },
  {
    ...
    spec: 'Outros recursos não vinculados que não se enquadram como impostos ou transferências de impostos. Inclui recursos de participação especial (det. 02), taxas sem destinação específica (det. 04) e receitas de compensação de precatórios com dívida ativa (CO 5001).',
    cos: [0, 5001],
    dets: ['00', '02', '03', '04', '49'],
  },
  {
  ...
  },
  {
    ...
    spec: 'Controle dos recursos de complementação da União ao FUNDEB — Valor Anual Aluno por Fundo (VAAF), com base na alínea a do inciso V do art. 212-A da CF. Na despesa, associar ao CO 1070 (remuneração dos profissionais).',
    cos: [0, 1070],
    dets: ['00', '49'],
  },
  {
  ...
  },
  {
    ...
    spec: 'Controle dos recursos decorrentes do recebimento de precatórios derivados de ações judiciais associadas à complementação devida pela União ao FUNDEF (Precatórios Fundef).',
    cos: [0],
    dets: ['00'],
  },
  {
  ...
  },
  {
    ...
    spec: 'Recursos de emendas individuais impositivas transferidos pela União por meio de transferências especiais (art. 166-A da CF). Pelo menos 70% devem ser aplicados em despesas de capital. Vedada aplicação em pessoal e serviço da dívida.',
    cos: [3110],
    dets: ['00'],
  },
  {
  ...
  },
  {
    ...
    spec: 'Controle dos recursos de emendas individuais impositivas transferidos pelos Estados por meio de transferências especiais, nos termos das Constituições Estaduais.',
    cos: [3210],
    dets: ['00'],
  },
  {
  ...
  },
  {
    ...
    spec: 'Controla as transferências obrigatórias de recursos do FAT. Pode receber COs de emendas individuais (3110) e de bancada (3120) da União.',
    cos: [0, 3110, 3120],
    dets: ['00'],
  },
  {
  ...
  },
  {
    ...
    spec: 'Controla os recursos para custeio da gratuidade nos transportes coletivos urbanos para maiores de 65 anos (art. 230, §2º da CF; art. 5º, IV da EC 123/2022).',
    cos: [0],
    dets: ['00'],
  },
  {
    ...
    spec: 'Controla os recursos das transferências para a Política Nacional Aldir Blanc de Fomento à Cultura previstas no art. 6º da Lei nº 14.399/2022.',
    cos: [0],
    dets: ['00'],
  },
  {
  ...
  },
  {
    ...
    spec: 'Controle dos recursos de outras transferências vinculadas da União não enquadrados nas fontes específicas anteriores. Esta fonte admite o maior conjunto de COs de emendas parlamentares e de calamidade pública.',
    cos: [0, 3101, 3110, 3111, 3120, 3121, 3130, 3140],
    dets: ['00'],
  },
  {
  ...
  },
  {
    ...
    cos: [0, 3101, 3110, 3111, 3120, 3121, 3130, 3140, 3210, 3211, 3220, 3221],
    dets: ['00'],
  },
  ...
  },
  {
    ...
    spec: 'Controle dos recursos de taxas, contribuições e preços públicos vinculados conforme legislações específicas. Inclui o detalhamento 01 para a Taxa de Vigilância Sanitária.',
    cos: [0],
    dets: ['00', '01'],
  },
  {
  ...
  },
  {
    ...
    spec: 'Controle dos recursos vinculados a fundos públicos, com exceção dos fundos relacionados à saúde, à educação, à assistência social e aos regimes de previdência. Inclui o Fundo de Mobilidade Urbana (det. 10 — Tesouro; det. 60 — Indiretas).',
    cos: [0],
    dets: ['00', '10', '60'],
  },
  {
  ...
  },
  {
    ...
    spec: 'Controle de outros recursos vinculados por lei não enquadrados nas especificações anteriores. Inclui a outorga onerosa do direito de construir (det. 12 — Tesouro; det. 62 — Indiretas).',
    cos: [0],
    dets: ['00', '12', '62'],
  },
  ...
  /* PREVIDÊNCIA */
  {
    ...
    spec: 'Controle dos recursos vinculados ao fundo em capitalização do RPPS. Plano existente tanto nos entes com quanto sem segregação da massa (Portaria MF nº 464/2018). Na despesa, associar ao CO que identifica o Poder ou Órgão executante.',
    cos: [1111, 1121],
    dets: ['00', '64'],
  },
  {
    ...
    spec: 'Controle dos recursos vinculados ao fundo em repartição do RPPS. Plano que deve existir apenas nos entes que segregaram a massa dos segurados (Portaria MF nº 464/2018). Na despesa, associar ao CO do Poder ou Órgão.',
    cos: [2111, 2121],
    dets: ['00'],
  },
  {
    ...
    spec: 'Controle dos recursos para custeio das despesas de organização e funcionamento da unidade gestora do RPPS (Portaria MPS nº 402/2008 e Portaria MF nº 464/2018, alteradas pela Portaria ME nº 19.451/2020).',
    cos: [0],
    dets: ['00'],
  },
  {
...
const DETALHAMENTOS = [
  ...
  { code: '02', range: 'tesouro', name: 'Participação especial', desc: 'Recurso de Participação Especial. Utilizado, por exemplo, nas FR 501 (outros não vinculados) e FR 720 (royalties — FEP).' },
  ...
  { code: '10', range: 'tesouro', name: 'Fundo de Mobilidade Urbana — Tesouro', desc: 'Recurso vinculado ao Fundo de Mobilidade Urbana arrecadado pelo Tesouro municipal. Dentro da FR 759 (recursos vinculados a fundos).' },
  { code: '12', range: 'tesouro', name: 'Outorga onerosa do direito de construir — Tesouro', desc: 'Recurso vinculado referente à outorga onerosa do direito de construir (art. 28 do Estatuto da Cidade). Dentro da FR 799 (outras vinculações legais).' },
  ...
  { code: '60', range: 'indireta', name: 'Fundo de Mobilidade Urbana — Indiretas', desc: 'Recurso vinculado ao Fundo de Mobilidade Urbana arrecadado pelas entidades da Administração Indireta. Dentro da FR 759.' },
  { code: '62', range: 'indireta', name: 'Outorga onerosa do direito de construir — Indiretas', desc: 'Recurso vinculado referente à outorga onerosa do direito de construir — Administração Indireta. Dentro da FR 799.' },
